      ...
      <div className="min-h-screen h-full w-full flex flex-col bg-brand-light overflow-hidden">
        ...
        <header className="min-w-full text-gray-800 py-14 px-4 md:px-0">
          <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
            <a href="#">
              <div className="font-coiny text-xl md:text-3xl font-bold">
                STKYFNGRS
              </div>
            </a>
          ...
          <div className="flex flex-col items-center max-w-4xl w-full">
            ...
            <div className="flex flex-col items-center md:flex-row md:space-x-16 space-y-10 mt-0 w-full">
              <div className="flex flex-col md:items-start items-center justify-center text-center font-coiny text-gray-800 px-4 md:px-0 py-5 mt-0">
                <p className="mt-6 text-lg">{`Welcome! Here you can mint one of my orignal photos as a 1 of 1 NFT, learn about the creator/developer/artist behind the site (yes, this is a one man show) and explore links to places I lurk on the internet. Stay tuned as this project has some surprises up it's sleave for hodlers.`}</p>
              </div>
            </div>
            <Link href="/mint">
            ...
            {/* Hidden until ready for 10k minting
              <Link href="/mint1Ok">
                <div className="mt-16 font-coiny uppercase inline-flex items-center px-6 oy-2 text-sm sm:text-2xl md:text-3xl font-medium text-center rounded text-rose-500 hover:bg-rose-600 hover:text-white">
